...
permalink: /authentication/strategies/username-password/
---
...
[Custom Strategy]({{ '/authentication/strategies/custom/' | relative_url }}) that calls your user store.
...
[OIDC strategy]({{ '/authentication/strategies/oidc/' | relative_url }}) with Client Credentials instead. The
